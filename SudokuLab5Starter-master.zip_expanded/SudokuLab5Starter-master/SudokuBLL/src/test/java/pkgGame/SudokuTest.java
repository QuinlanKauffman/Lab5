...
*/	
	...
	public void enumTest() {
		...
		System.out.println(egd.getiDifficultyValue());
		
		eGameDifficulty egd2 = eGameDifficulty.MEDIUM;
		System.out.println(egd2.getiDifficultyValue());
		
		eGameDifficulty egd3 = eGameDifficulty.HARD;
		System.out.println(egd3.getiDifficultyValue());
	...
	public void isDiffMetTest() throws Exception
	{
		...
		Sudoku s2 = new Sudoku(eGameDifficulty.MEDIUM,9);
		s2.PrintPuzzle();
